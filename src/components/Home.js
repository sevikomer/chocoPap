...
function Home() {
  return (
    <div className='relative'>
      ...
      <Link to="/shop" className='bg-orange hover:bg-yellow text-white shadow-xl shadow-black p-2 lg:text-5xl md:text-3xl sm:text-2xl text-xl absolute z-10 bottom-1/3 left-1/3 rounded'>VOIR LA BOUTIQUE</Link>
    </div>
  )
}
